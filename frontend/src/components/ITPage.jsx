    ...
    <div id="page-it" style={{ paddingTop: '80px', minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      <section className="it-sec" id="it-svc" style={{ padding: '80px 8%', background: 'var(--surf-1)', borderTop: '1px solid var(--border-primary)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '24px' }}>
            {[
              { t: 'Fintech & Payment Portals', d: 'AEPS dashboards, BBPS portals, payout systems and agent networks — built secure and RBI-compliant. We have shipped portals processing Rs 50L+ in daily transactions.', tags: ['BBPS API', 'AEPS', 'UPI', 'RBI'], icon: <Server size={22} />, glow: 'rgba(45,184,75,0.18)' },
      ...
      <section className="it-sec" id="it-port" style={{ padding: '80px 8%', background: 'var(--surf-1)', borderTop: '1px solid var(--border-primary)', borderBottom: '1px solid var(--border-primary)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '24px' }}>
            {[
              { t: 'BillsPay24X7 Agent Portal', tag: 'FINTECH PLATFORM', p: 'Full-stack fintech portal — AEPS, BBPS, UPI and payout in one dashboard. Multi-tier agent hierarchy, real-time monitoring, T+1 settlement.', kpis: ['₹50L+ daily volume', '500+ agents'], bg: 'linear-gradient(135deg, #1B2A6B, #0D1638)', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=560&h=300&fit=crop&q=80' },

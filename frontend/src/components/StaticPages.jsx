...
function GeometricNodeMap() {
  return (
    <div style={{
      ...
      width: '100%',
      height: '320px',
      background: 'linear-gradient(135deg, #08221A 0%, #0F3A2B 100%)',
      borderRadius: '24px',
      overflow: 'hidden',
      display: 'flex',
      alignItems: 'center',
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        backgroundImage: 'radial-gradient(circle at 80% 20%, rgba(27, 98, 71, 0.15) 0%, transparent 50%), radial-gradient(circle at 10% 80%, rgba(30, 104, 73, 0.12) 0%, transparent 50%)',
        zIndex: 0
      }} />

      <svg width="280" height="200" viewBox="0 0 280 200" style={{ position: 'relative', zIndex: 1 }}>
        {/* Connection Lines */}
        <motion.line x1="50" y1="100" x2="140" y2="40" stroke="rgba(27, 98, 71,0.4)" strokeWidth="2"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, repeat: Infinity, repeatType: "reverse" }} />
        <motion.line x1="50" y1="100" x2="140" y2="160" stroke="rgba(27, 98, 71,0.4)" strokeWidth="2"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2.2, repeat: Infinity, repeatType: "reverse" }} />
        <motion.line x1="140" y1="40" x2="230" y2="100" stroke="rgba(30, 104, 73,0.4)" strokeWidth="2"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.8, repeat: Infinity, repeatType: "reverse" }} />
        <motion.line x1="140" y1="160" x2="230" y2="100" stroke="rgba(30, 104, 73,0.4)" strokeWidth="2"
        ...
        <motion.circle cx="140" cy="100" r="18" fill="rgba(27, 98, 71, 0.15)" stroke="var(--accent-periwinkle)" strokeWidth="2" />
        <text x="140" y="104" textAnchor="middle" fontSize="10" fontWeight="900" fill="#fff" fontFamily="var(--font-mono)">B2B</text>

        {/* Node 1 */}
        <motion.circle cx="50" cy="100" r="14" fill="rgba(11, 42, 32, 0.8)" stroke="var(--accent-periwinkle)" strokeWidth="2"
        ...
        {/* Node 2 */}
        <motion.circle cx="140" cy="40" r="14" fill="rgba(11, 42, 32, 0.8)" stroke="#1E6849" strokeWidth="2"
          animate={{ y: [40, 44, 40] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} />
        <text x="140" y="43" textAnchor="middle" fontSize="9" fill="#1E6849" fontWeight="bold">💳</text>

        {/* Node 3 */}
        <motion.circle cx="230" cy="100" r="14" fill="rgba(11, 42, 32, 0.8)" stroke="var(--accent-periwinkle)" strokeWidth="2"
        ...
        {/* Node 4 */}
        <motion.circle cx="140" cy="160" r="14" fill="rgba(11, 42, 32, 0.8)" stroke="#1E6849" strokeWidth="2"
          animate={{ y: [160, 156, 160] }} transition={{ duration: 3.2, repeat: Infinity, ease: 'easeInOut' }} />
        <text x="140" y="163" textAnchor="middle" fontSize="9" fill="#1E6849" fontWeight="bold">⚙️</text>
      </svg>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <motion.p
            ...
            style={{ fontSize: '18px', fontWeight: 700, color: '#1E6849', marginBottom: '16px' }}
          >
      ...
      <div style={{ padding: '80px 8%', background: 'var(--bg-primary)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px' }}>
            {[
              { icon: <Target size={22} />, t: 'Mission', d: 'Empower every business with seamless digital financial and technology services.', glow: 'rgba(30, 104, 73,0.15)' },
              { icon: <Eye size={22} />, t: 'Vision', d: 'Become India\'s most trusted platform for fintech, travel, and IT solutions.', glow: 'rgba(27, 98, 71,0.15)' },
              { icon: <Shield size={22} />, t: 'Integrity', d: 'We operate with transparency, security, and compliance at every level.', glow: 'rgba(30, 104, 73,0.15)' },
  ...
  return (
    <div style={{ paddingTop: '100px', minHeight: '100vh', background: 'var(--surf-1)' }}>
      ...
      <div style={{ padding: '80px 8% 40px', background: 'linear-gradient(180deg, #F0F4FF 0%, #FFFFFF 100%)', textAlign: 'center' }}>
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 800, color: '#0F3A2B', marginBottom: '16px' }}>Pricing</h1>
        <p style={{ fontSize: '18px', fontWeight: 600, color: '#1E6849', marginBottom: '8px' }}>Simple, Transparent Pricing</p>
      ...
      <div style={{ padding: '60px 8%', background: '#fff' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid var(--border-primary)', padding: '36px', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#0F3A2B', marginBottom: '8px' }}>Starter</h3>
            <div style={{ fontSize: '32px', fontWeight: 900, margin: '14px 0', color: '#0F3A2B' }}>₹0 <span style={{ fontSize: '12px', fontWeight: 500, color: 'var(--text-secondary)' }}>/ month</span></div>
          ...
          {/* Plan 2 */}
          <div style={{ background: '#fff', borderRadius: '20px', border: '2px solid #1E6849', padding: '36px', textAlign: 'center', position: 'relative', display: 'flex', flexDirection: 'column', boxShadow: '0 8px 32px rgba(30, 104, 73,0.06)' }}>
            <span style={{ position: 'absolute', top: '-12px', right: '20px', background: '#1E6849', color: '#fff', fontSize: '9px', fontWeight: 700, padding: '4px 12px', borderRadius: '50px' }}>POPULAR</span>
            <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#0F3A2B', marginBottom: '8px' }}>Business</h3>
            <div style={{ fontSize: '32px', fontWeight: 900, margin: '14px 0', color: '#0F3A2B' }}>₹2,999 <span style={{ fontSize: '12px', fontWeight: 500, color: 'var(--text-secondary)' }}>/ month</span></div>
            <ul style={{ listStyle: 'none', padding: 0, margin: '20px 0', flex: 1, textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          {/* Plan 3 */}
          <div style={{ background: '#fff', borderRadius: '20px', border: '1px solid var(--border-primary)', padding: '36px', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#0F3A2B', marginBottom: '8px' }}>Enterprise</h3>
            <div style={{ fontSize: '32px', fontWeight: 900, margin: '14px 0', color: '#0F3A2B' }}>Custom</div>
            <ul style={{ listStyle: 'none', padding: 0, margin: '20px 0', flex: 1, textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          {selectedTag === 'All' && blogPosts.length > 0 && (
            <motion.div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = 'var(--accent-periwinkle)';
                e.currentTarget.style.boxShadow = '0 16px 40px rgba(27, 98, 71,0.06)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = 'var(--border-primary)';
            ...
            >
              ...
              <div style={{ padding: '36px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '14px' }}>
                  <span style={{ fontSize: '9px', background: 'rgba(27, 98, 71,0.08)', color: 'var(--accent-periwinkle)', padding: '4px 10px', borderRadius: '50px', fontWeight: 800 }}>{blogPosts[0].tag}</span>
          ...
          <div style={{
            ...
            {(selectedTag === 'All' ? filteredPosts.slice(1) : filteredPosts).map((post, idx) => (
              <motion.div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = 'var(--accent-periwinkle)';
                  e.currentTarget.style.boxShadow = '0 16px 40px rgba(27, 98, 71,0.05)';
                  e.currentTarget.style.transform = 'translateY(-4px)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = 'var(--border-primary)';
              ...
              >
                <div style={{ height: '170px', overflow: 'hidden', position: 'relative' }}>
                  ...
                  <span style={{
                    ...
                    fontSize: '9px', background: 'rgba(15, 58, 43,0.8)', color: '#fff',
...
export function PartnersPage() {
  return (
    <div style={{ paddingTop: '100px', minHeight: '100vh', background: 'var(--surf-1)' }}>
      {/* Hero */}
      <div style={{ padding: '80px 8% 40px', background: 'linear-gradient(180deg, #F0F4FF 0%, #FFFFFF 100%)', textAlign: 'center' }}>
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 800, color: '#0F3A2B', marginBottom: '16px' }}>Our Partners</h1>
        <p style={{ fontSize: '18px', fontWeight: 600, color: '#1E6849', marginBottom: '8px' }}>Trusted Network</p>
        <p style={{ fontSize: '15px', color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
          {[
            ...
            <div key={idx} style={{ background: '#fff', border: '1px solid var(--border-primary)', borderRadius: '16px', padding: '24px', textAlign: 'center' }}>
              <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'linear-gradient(135deg, #0F3A2B, #1E6849)', display: 'flex', alignItems: 'center', justify: 'center', color: '#fff', fontSize: '18px', fontWeight: 800, margin: '0 auto 16px' }}>{partner.name}</div>
